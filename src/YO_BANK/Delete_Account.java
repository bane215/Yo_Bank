...
public class Delete_Account {
	 ...
	 public Delete_Account() throws SQLException,Exception
{
	     ...
	     stmt = conn.prepareStatement("delete from accavailable where accid=?");
	     stmt.setString(1,accid);
	     stmt.executeUpdate();
	     
	     stmt = conn.prepareStatement("delete from deposit where accid=?");
	     stmt.setString(1,accid);
	     stmt.executeUpdate();
	     
	     stmt = conn.prepareStatement("delete from withdraw where accid=?");
	     stmt.setString(1,accid);
	     stmt.executeUpdate();
	     			     
	     System.out.println("\nAccount "+accid+" Successfully Closed!");
